...
<p align="center">
의료 데이터에 AI를 적용하고, 분석 결과를 실제로 사용할 수 있는 웹·앱 서비스로 연결하는 과정에 관심이 있습니다.
</p>

## About Me

- 의료IT공학과에서 의료 AI와 웹 개발을 공부하고 있습니다.
- 의료 영상과 생체 신호를 다루는 딥러닝 프로젝트를 진행했습니다.
- 모델 구현뿐 아니라 데이터베이스, 백엔드, 화면을 연결해 하나의 서비스로 만드는 경험을 쌓고 있습니다.
